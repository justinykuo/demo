    ...
    <Box sx={{ display: "flex" }}>
      ...
      >
        <List>
          ...
          <ListItem button component={Link} href="/users" onClick={handleItemClick}>
            <ListItemText primary="Users" />
          </ListItem>
          <ListItem button component={Link} href="/events" onClick={handleItemClick}>
            <ListItemText primary="Events" />
          </ListItem>
          <ListItem button component={Link} href="/visualization" onClick={handleItemClick}>
